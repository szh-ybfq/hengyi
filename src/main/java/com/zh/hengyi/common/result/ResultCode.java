...
public enum ResultCode {
    ...
    GET_IMAGE_SPU_NOT_EXIST(4422, "商品不存在,获取图片失败"),
    SPU_NAME_DUPLICATE(4423, "商品名称已存在"),
    SPU_IMAGE_NOT_EXIST(4424, "商品图片不存在"),
    SPU_IMAGE_MAIN_NUM_OUTPUT(4425, "商品主图仅可上传一张"),
     ...
     */
    IO_ERROR(5000, "IO异常"),
    FILE_NOT_EXIST(5011, "文件参数为空,请检查后重试"),
    IMG_HTTP_NOT_EXIST(5012, "图片参数为空，请检查后重试"),
    FILE_TYPE_EXIST(5016, "文件类型参数为空,请检查后重试"),
    VIDEO_NOT_EXIST(5013, "视频不存在"),
    UPLOAD_IMAGE_OSS_ERROR(5016, "上传图片到云服务OSS失败"),
    UPLOAD_IMAGE_DB_ERROR(5017, "上传图片到数据库失败"),
