...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Order> implements OrderService {
    ...
    public void createOrder(OrderCreateDTO dto) {
        ...
        allCartMap = cartService.validCartCacheExist(allCartMap);
        ...
        // 8.发送延迟消息，30分钟超时自动关单
        orderDelayProducer.sendOrderDelayMsg(order.getId());
        // TODO 后续迭代：1. 库存扣减
    }
    ...
    // 校验订单状态
    @Override
    public void validOrderStatus(Order order){
